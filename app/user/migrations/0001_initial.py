    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, default=None, max_length=500, null=True)),
                ('password', models.CharField(max_length=500)),
                ('image', models.ImageField(default='images/profil_images/default.png', null=True, upload_to='images/profil_images/')),
